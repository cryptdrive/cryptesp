...
#ifdef _WIN32
        ImGui::TextUnformatted("Config is saved as \"config.txt\" inside Crypt directory in Documents");
#elif __linux__
        ImGui::TextUnformatted("Config is saved as \"config.txt\" inside ~/Crypt directory");
#endif
